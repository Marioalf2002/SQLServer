...
INSERT INTO EMPLEADOS
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
...
INSERT INTO Proveedores
    (Id, Descripcion, Direccion, Telefono, Fecha_Vinc)
VALUES
...
insert into PRODUCTOS
    (id,Descripcion,Cantidad,Precio,ProveedorId,Fecha_Vencimiento,Prod_Code)
values
    (01, 'mantequilla 500 gr', 10, 5500, 04, '2024-02-12', 100);

insert into PRODUCTOS
    (id,Descripcion,Cantidad,Precio,ProveedorId,Fecha_Vencimiento,Prod_Code)
values
    (02, 'leche bolsa entera', 20, 4500, 04, '2024-02-14', 101);

insert into PRODUCTOS
    (id,Descripcion,Cantidad,Precio,ProveedorId,Fecha_Vencimiento,Prod_Code)
values
    (03, 'arepa blanca x 5', 5, 2000, 04, '2024-02-15', 102);

insert into PRODUCTOS
    (id,Descripcion,Cantidad,Precio,ProveedorId,Fecha_Vencimiento,Prod_Code)
values
    (04, 'cocacola 1 litro', 15, 6500, 02, '2026-02-12', 103);

insert into PRODUCTOS
    (id,Descripcion,Cantidad,Precio,ProveedorId,Fecha_Vencimiento,Prod_Code)
values
    (05, 'pepsi x 3 litros', 15, 6200, 03, '2025-11-21', 104);

insert into PRODUCTOS
    (id,Descripcion,Cantidad,Precio,ProveedorId,Fecha_Vencimiento,Prod_Code)
values
    (06, 'pan tajado bimbo', 10, 6000, 05, '2024-03-12', 105);

insert into PRODUCTOS
    (id,Descripcion,Cantidad,Precio,ProveedorId,Fecha_Vencimiento,Prod_Code)
values
    (07, 'manzana verde x unidad', 30, 2000, 04, '2024-04-12', 106);

insert into PRODUCTOS
    (id,Descripcion,Cantidad,Precio,ProveedorId,Fecha_Vencimiento,Prod_Code)
values
    (08, 'mango tomy x unidad', 10, 1000, 04, '2024-04-12', 107);

insert into PRODUCTOS
    (id,Descripcion,Cantidad,Precio,ProveedorId,Fecha_Vencimiento,Prod_Code)
values
    (09, 'papas de limon margarita x 500 gr', 18, 7000, 05, '2024-05-10', 108);

insert into PRODUCTOS
    (id,Descripcion,Cantidad,Precio,ProveedorId,Fecha_Vencimiento,Prod_Code)
values
    (10, 'huevo blanco #2 x canasta', 10, 13000, 05, '2024-03-12', 109);


INSERT INTO CLIENTES
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
    (1, 'Juan', 'Gomez', 'Av. Principal 123', '555-1234', '2023-01-15');

INSERT INTO CLIENTES
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
    (2, 'Maria', 'Rodriguez', 'Calle Robles 456', '555-5678', '2023-02-20');

INSERT INTO CLIENTES
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
    (3, 'Carlos', 'Lopez', 'Barrio Flores 789', '555-9012', '2023-03-25');

INSERT INTO CLIENTES
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
    (4, 'Ana', 'Martinez', 'Esquina Palmas 101', '555-3456', '2023-04-10');

INSERT INTO CLIENTES
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
    (5, 'Pedro', 'Santos', 'Colonia Pinos 202', '555-7890', '2023-05-15');

INSERT INTO CLIENTES
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
    (6, 'Laura', 'Fernandez', 'Residencial Alamos 303', '555-1234', '2023-06-20');

INSERT INTO CLIENTES
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
    (7, 'Fernando', 'Gonzalez', 'Condominio Cedros 404', '555-5678', '2023-07-25');

INSERT INTO CLIENTES
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
    (8, 'Marta', 'Hernandez', 'Urbanizacion Nogales 505', '555-9012', '2023-08-30');

INSERT INTO CLIENTES
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
    (9, 'Ricardo', 'Diaz', 'Callejón Laurel 606', '555-3456', '2023-09-05');

INSERT INTO CLIENTES
    (Id, Nombre, Apellido, Direccion, Telefono, Fecha_Vinc)
VALUES
    (10, 'Elena', 'Perez', 'Avenida Pino Real 707', '555-7890', '2023-10-10');
INSERT INTO FACTURAS
    (Id, Cliente, Descripcion, Cantidad, Precio, Fecha, Fact_Code, EmpleId)
VALUES
...
as
    -- Creamos la vista con el nombre 'EMPLEADOS_Vista' donde contiene el nombre y apellido de empleados
    select Nombre, Apellido
    from empleado

select *
from EMPLEADOS_Vista
-- Se Usa para ejecturas la vista creada

create view PRODUCTOS_Vista
as
...
create view Promedio_Productos
as
    select *
    from productos
...
select *
from Promedio_Productos

select *
from EMPLEADOS_Vista
where Apellido like '%z'

create view ApellidosNombres
as
    select *
    from EMPLEADOS_Vista
...
BEGIN
    ...
    set @nombre = (Select nombre + ' ' + apellido
    from EMPLEADOS
    where id = @id)
    RETURN @nombre
END
...
select *
from dbo.informacion('Hernández')
GO
...
BEGIN
    INSERT INTO @CLIENTES
        (Id,Nombre,Apellido,Direccion,Telefono,Fecha_Vinc,Total)
    ...
    WHERE FACTURAS.precio*FACTURAS.cantidad = (SELECT MAX(FACTURAS.precio*FACTURAS.cantidad)
    FROM FACTURAS)
    RETURN
END
GO
...
returns TABLE
AS
RETURN (select Descripcion, Precio, Nombre, Apellido, Fecha_Vinc
...
AS
BEGIN
    DELETE FROM PROVEEDORES WHERE Id = (SELECT MAX(Id)
    FROM PROVEEDORES)
END
GO
...
CREATE PROCEDURE PrecioArticulo
    @id INT
AS
BEGIN
    ...
    FROM PRODUCTOS
    WHERE Id = @id)
    SET @precio = (SELECT CAST(Precio AS VARCHAR(150))
    FROM PRODUCTOS
    WHERE Id = @id)
...
CREATE VIEW ComprasPorEncimaDelPromedio
AS
    SELECT C.Id, C.Nombre, C.Apellido, C.Direccion, C.Telefono, C.Fecha_Vinc, F.Descripcion, F.Cantidad, F.precio, F.Fecha
    FROM CLIENTES C, FACTURAS F
    WHERE C.Id = F.Cliente AND F.precio*F.Cantidad > (SELECT AVG(precio*Cantidad)
        FROM FACTURAS)
GO

select *
from ComprasPorEncimaDelPromedio
...
BEGIN
    ...
    FROM CLIENTES C, FACTURAS F
    WHERE C.Id = F.Cliente AND F.precio*F.Cantidad = (SELECT MAX(precio*Cantidad)
        FROM FACTURAS)
...
BEGIN
    INSERT INTO PRODUCTOS
    VALUES
        (@id, @desc, @cant, @precio, @proveedorid, @fecha, @prodcode)
END
GO
...
AS
BEGIN
    DELETE FROM EMPLEADOS WHERE Id NOT IN (SELECT EmpleId
    FROM FACTURAS)
END
GO
...
CREATE PROCEDURE MostrarClienteFactura
    @cod INT
AS
BEGIN
    SELECT *
    FROM ClientesFacturas
    WHERE IdFacturas = @cod
END
GO
